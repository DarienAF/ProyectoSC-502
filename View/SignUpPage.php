...
<head>
    ...
    <link rel="stylesheet" href="./Vista/style/SingUpStyle.css">
    <style>
        body {
            ...
            background-image: url(http://localhost/dashboard/ProyectoSC-502/Vista/imagen/Login.png);
        }
...
<section id="Nav">
    <div class="Nav">
        <ul class="nav justify-content-end container-fluid">
            ...
            <li class="nav-item">
                <a href="http://localhost/dashboard/ProyectoSC-502/index.php?controlador=LoginPage&accion=index">INICIAR
                    SESIÓN</a>
            </li>
            <li class="nav-item">
                <a class="redButton active" href="http://localhost/dashboard/ProyectoSC-502/index.php?controlador=SignUpPage&accion=index">¡ÚNETE YA!</a>
            </li>
            <li class="nav-item">
                <a href="#">PRECIOS</a>
            </li>
    ...
    <div class="Contenido container text-center mt-5">
        <div class="row align-items-center">
            <div class="col-6 Logo">
                <img src="http://localhost/dashboard/ProyectoSC-502/Vista/imagen/Logo.svg" width=500px height="50%">
            </div>
            <div class="col-6 Login">
                ...
                <div class="Form">
                    ...
                    <a class="AlreadyAccount" href="http://localhost/dashboard/ProyectoSC-502/index.php?controlador=Login&accion=index">¿Ya tienes una cuenta?
                        Inicia Sesión</a>
