        ...
        <table class="table table-striped table-dark" id="tablaUsuario">
            <thead>
                ...
                <tr>
                    ...
                    <th><input type="text" id="searchPhone" placeholder="Buscar" oninput="filterTable()"
                            class="form-control">
                    </th>
                    <?php echo ($userRole == 1) ?
                        (' 
            ...
            <tbody>
                <?php foreach ($users as $user): ?>
                    <tr id="userRow-<?php echo $user->getIdUsuario(); ?>">
                        ...
                        <td id="userId-<?php echo $user->getIdUsuario(); ?>">
                            <?php echo htmlspecialchars($user->getIdUsuario()); ?>
                        </td>
                        ...
                        <td id="username-<?php echo $user->getIdUsuario(); ?>">
                            <?php echo htmlspecialchars($user->getUsername()); ?>
                        </td>
                        <td id="firstName-<?php echo $user->getIdUsuario(); ?>">
                            <?php echo htmlspecialchars($user->getNombre()); ?>
                        </td>
                        <td id="lastName-<?php echo $user->getIdUsuario(); ?>">
                            <?php echo htmlspecialchars($user->getApellidos()); ?>
                        </td>
                        <td id="email-<?php echo $user->getIdUsuario(); ?>">
                            <?php echo htmlspecialchars($user->getCorreo()); ?>
                        </td>
                        <td id="phone-<?php echo $user->getIdUsuario(); ?>">
                            <?php echo htmlspecialchars($user->getTelefono()); ?>
                        </td>
                        <?php
                        if ($userRole == 1) {
                ...
                <div class="modal-body">
                    <form id="editUserForm">
                        <div class="modal-image-container">
                            <img id="userProfileImage" src="" alt="Imagen de perfil"
