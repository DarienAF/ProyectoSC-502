$(document).ready(function () {
    ...
    CargarConteoUsuariosPorRol()
    function CargarConteoUsuariosPorRol() {
        fetch('./index.php?controller=ReportsPage&action=obtenerConteoRol')
            .then(response => response.json())
            .then(data => {
                var ctx = document.getElementById('myChart4').getContext('2d');
                var myChart = new Chart(ctx, {
                    type: 'doughnut', // Cambiamos el tipo de gráfico a 'doughnut'
                    data: {
                        labels: data.nombres_roles, // Etiquetas
                        datasets: [{
                            data: data.cantidades_usuarios, // Datos
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Conteo de usuarios por rol'
                            }
                        }
                    }
                });
