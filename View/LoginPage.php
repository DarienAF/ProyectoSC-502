...
<head>
    ...
    <link rel="stylesheet" href="./Vista/style/LoginStyle.css">
    <style>
        body {
            ...
            <div class="col-6 Login">
                ...
                <div class="Opciones">
                    <a class=" mb-5 Google" href="#"><img
                                src="http://localhost/dashboard/ProyectoSC-502/Vista/imagen/google.png"> Iniciar Sesión
                        con Google</a>
                    <p class=" mb-5 NoAccount"><a>No Account ?</a>
                        <a style="color: #779341" href="http://localhost/dashboard/ProyectoSC-502/index.php?controlador=SignUp&accion=Index">Sign up</a>
                    </p>
                </div>
